...
import com.DBProject.repository.IcDAOImpl;
...
public class CoordinatorController {
    ...
    public GetFeeStudents getFeeStudents() {
        ...
        return new GetFeeStudents(icDAO.getHerStudentsLessThanAStage(coordinatorName, String.valueOf(3)));
    }
    ...
    public StageUpdateResponse advanceFeeStudents(@RequestBody AdvanceFeeStudent advanceFeeStudent) {
        final String coordinatorName = getUsername();
        icDAO.advanceHerStudents(coordinatorName, String.valueOf(4));
